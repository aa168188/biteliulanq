!(function (t, r) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(r)
    : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).jsSHA = r())
})(this, function () {
  'use strict'
  var t = function (r, n) {
    return (
  ...
  function o(t, o, u) {
    ...
    switch (t) {
                ...
                for (
                  u = [],
                    128 > (o = t.charCodeAt(s))
                      ...
                      : 55296 > o || 57344 <= o
                      ? u.push(224 | (o >>> 12), 128 | ((o >>> 6) & 63), 128 | (63 & o))
                      : ((s += 1),
                  ...
                  for (h = (a = E + l) >>> 2; v.length <= h; ) v.push(0)
                  ;(v[h] |= u[f] << (8 * (c + e * (a % 4)))), (E += 1)
                }
            else
              for (c = -1 === e ? 2 : 0, w = ('UTF16LE' === r && 1 !== e) || ('UTF16LE' !== r && 1 === e), s = 0; s < t.length; s += 1) {
                for (o = t.charCodeAt(s), !0 === w && (o = ((f = 255 & o) << 8) | (o >>> 8)), h = (a = E + l) >>> 2; v.length <= h; )
                  v.push(0)
                ;(v[h] |= o << (8 * (c + e * (a % 4)))), (E += 2)
              }
      ...
      case 'B64':
        return function (t, n, i) {
          return (function (t, n, i, e) {
            ...
            if (((t = t.replace(/=/g, '')), -1 !== l && l < t.length)) throw new Error("Invalid '=' found in base-64 string")
            for (o = 0; o < t.length; o += 4) {
              for (f = t.substr(o, 4), s = 0, u = 0; u < f.length; u += 1) s |= r.indexOf(f.charAt(u)) << (18 - 6 * u)
              for (u = 0; u < f.length - 1; u += 1) {
                for (h = (a = c + E) >>> 2; w.length <= h; ) w.push(0)
                ;(w[h] |= ((s >>> (16 - 8 * u)) & 255) << (8 * (v + e * (a % 4)))), (c += 1)
              }
            }
        ...
        return function (t, r, n) {
          return (function (t, r, n, i) {
            ...
            for (o = 0; o < t.length; o += 1)
              (e = t.charCodeAt(o)), (u = (s = o + h) >>> 2), f.length <= u && f.push(0), (f[u] |= e << (8 * (a + i * (s % 4))))
      ...
      case 'ARRAYBUFFER':
        ...
        return function (t, r, n) {
          return (function (t, r, n, i) {
            return e(new Uint8Array(t), r, n, i)
          })(t, r, n, u)
        }
      case 'UINT8ARRAY':
        try {
        ...
        return function (t) {
          return (function (t, r, n, i) {
            var e,
              ...
              f = r / 8,
              h = -1 === n ? 3 : 0
            for (e = 0; e < f; e += 1) (o = t[e >>> 2] >>> (8 * (h + n * (e % 4)))), (s += u.charAt((o >>> 4) & 15) + u.charAt(15 & o))
          ...
          return (function (t, n, i, e) {
            ...
            for (o = 0; o < c; o += 3)
              for (
                ...
                a += 8 * o + 6 * u <= n ? r.charAt((s >>> (6 * (3 - u))) & 63) : e.b64Pad
            return a
          })(t, e, o, u)
        }
      case 'BYTES':
  ...
  function v(t, r) {
    var n,
      ...
      v,
      l = []
    for (n = r[0], i = r[1], e = r[2], o = r[3], u = r[4], E = 0; E < 80; E += 1)
      (l[E] = E < 16 ? t[E] : f(l[E - 3] ^ l[E - 8] ^ l[E - 14] ^ l[E - 16], 1)),
        (s =
          E < 20
            ? w(f(n, 5), ((v = i) & e) ^ (~v & o), u, 1518500249, l[E])
            : E < 40
            ? w(f(n, 5), h(i, e, o), u, 1859775393, l[E])
            : E < 60
            ? w(f(n, 5), a(i, e, o), u, 2400959708, l[E])
            : w(f(n, 5), h(i, e, o), u, 3395469782, l[E])),
        (u = o),
        (o = e),
        (e = f(i, 30)),
        (i = n),
        (n = s)
    return (r[0] = c(n, r[0])), (r[1] = c(i, r[1])), (r[2] = c(e, r[2])), (r[3] = c(o, r[3])), (r[4] = c(u, r[4])), r
  }
  function l(t, r, n, i) {
    for (var e, o = 15 + (((r + 65) >>> 9) << 4), u = r + n; t.length <= o; ) t.push(0)
    for (t[r >>> 5] |= 128 << (24 - (r % 32)), t[o] = 4294967295 & u, t[o - 1] = (u / 4294967296) | 0, e = 0; e < t.length; e += 16)
      i = v(t.slice(e, e + 16), i)
    return i
  }
  return (function (r) {
    function n(t, n, i) {
      ...
      return (
        ...
        (e.U = E),
        (e.T = l),
        (e.R = [1732584193, 4023233417, 2562383102, 271733878, 3285377520]),
        (e.m = 512),
        (e.F = 160),
        (e.g = !1),
        u.hmacKey &&
          e.B(
            (function (t, r, n, i) {
              var e = t + ' must include a value and format'
              if (!r) {
                if (!i) throw new Error(e)
                return i
              }
              if (void 0 === r.value || !r.format) throw new Error(e)
              return o(r.format, r.encoding || 'UTF8', n)(r.value)
    ...
    (function () {
      function t(t, r, n) {
        ...
        ;(this.Y = t), (this.C = []), (this.I = 0), (this.H = !1), (this.L = 0), (this.S = !1), (this.N = []), (this.X = [])
      }
      return (
        (t.prototype.update = function (t) {
          var r,
            n = 0,
            i = this.m >>> 5,
            e = this.h(t, this.C, this.I),
            o = e.binLen,
            u = e.value,
            s = o >>> 5
          for (r = 0; r < s; r += i) n + this.m <= o && ((this.R = this.A(u.slice(r, r + i), this.R)), (n += this.m))
          return (this.L += n), (this.C = u.slice(n >>> 5)), (this.I = o % this.m), (this.H = !0), this
        }),
        (t.prototype.getHash = function (t, r) {
          ...
          var f = u(t, e, this.u, o)
          if (this.S && this.i) return f(this.i(o))
          for (i = this.T(this.C.slice(), this.I, this.L, this.p(this.R), e), n = 1; n < this.numRounds; n += 1)
            this.g && e % 32 != 0 && (i[i.length - 1] &= 16777215 >>> (24 - (e % 32))), (i = this.T(i, e, 0, this.U(this.Y), e))
          return f(i)
        }),
        (t.prototype.setHMACKey = function (t, r, n) {
          if (!this.t) throw new Error('Variant does not support HMAC')
          if (this.H) throw new Error('Cannot set MAC key after calling update')
          var i = o(r, (n || {}).encoding || 'UTF8', this.u)
          this.B(i(t))
        }),
        (t.prototype.B = function (t) {
          ...
          if (this.S) throw new Error('MAC key already set')
          for (n < t.binLen / 8 && (t.value = this.T(t.value, t.binLen, 0, this.U(this.Y), this.F)); t.value.length <= i; ) t.value.push(0)
          for (r = 0; r <= i; r += 1) (this.N[r] = 909522486 ^ t.value[r]), (this.X[r] = 1549556828 ^ t.value[r])
          ;(this.R = this.A(this.N, this.R)), (this.L = this.m), (this.S = !0)
        }),
        (t.prototype.getHMAC = function (t, r) {
          var n = s(r)
          return u(t, this.F, this.u, n)(this.o())
        }),
        (t.prototype.o = function () {
          var t
          if (!this.S) throw new Error('Cannot call getHMAC without first setting MAC key')
          var r = this.T(this.C.slice(), this.I, this.L, this.p(this.R), this.F)
          return (t = this.A(this.X, this.U(this.Y))), (t = this.T(r, this.F, this.m, t, this.F))
        }),
        t
      )
    })()
